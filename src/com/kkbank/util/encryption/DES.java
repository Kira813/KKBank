...
public class DES {  
    ...
    /** 加密<a href="http://lib.csdn.net/base/31" class='replace_word' title="算法与数据结构知识库" target='_blank' style='color:#df3434; font-weight:bold;'>算法</a>,可用 DES,DESede,Blowfish. */  
    ...
    public static byte[] hex2byte(byte[] b) {  
        if ((b.length % 2) != 0)  
            throw new IllegalArgumentException("The length is not even");  //长度不是偶数会抛异常
