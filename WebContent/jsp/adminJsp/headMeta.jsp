...
<!-- Daterange picker -->
<link href="./resource/css/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
<!-- bootstrap wysihtml5 - text editor -->
<link href="./resource/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
<!-- Theme style -->
<link href="./resource/css/AdminLTE.css" rel="stylesheet" type="text/css" />
<link href="./resource/AdminLTE-2.3.3/dist/css/AdminLTE.css" rel="stylesheet" type="text/css" />
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="./resource/AdminLTE-2.3.3/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="./resource/AdminLTE-2.3.3/bootstrap/css/bootstrap.css">
  <!-- Font Awesome -->
